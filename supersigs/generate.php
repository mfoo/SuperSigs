			...
			<div class="left" style="width: 100%;">
				...
				<div class="content">
					...
					<?php
							...
							echo "[url=http://" . $servername . "/" . $statsDir . "/hlstats.php?mode=playerinfo&player=" . $data['playerId'] . "][img]http://" . $servername . "/" . $sigsDir . "/" . ($linkType == "php" ? "index.php" : "sig.jpg") . "?id=". urlencode($_POST['id']) . $url . "[/img][/url]";
							echo "</textarea>";
